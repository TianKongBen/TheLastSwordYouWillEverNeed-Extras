...
import net.tianben.tlsywen.entity.LDlv5Entity;
import org.jetbrains.annotations.Nullable;

import java.util.List;

public class TheLastSwordYouWillEverNeedlv5Item extends SwordItem {

    private final int attackDamage;

    private static final float ATTACK_SPEED = -2.4f;

    public TheLastSwordYouWillEverNeedlv5Item(ToolMaterial toolMaterial) {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            LDlv5Entity lightningProjectileEntity = new LDlv5Entity(world, user);
